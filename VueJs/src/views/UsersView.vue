        ...
        <div v-if="showUserModal" class="fixed inset-y-0 right-0 z-[101] w-[450px] bg-white shadow-[-10px_0_30px_rgba(0,0,0,0.1)] flex flex-col border-l border-[#e2e8f0]">
          ...
          <div class="theme-modal-header relative overflow-hidden flex items-center justify-between px-8 py-6 transition-colors duration-500" :class="{ 'easter-egg-space': isSpaceEasterEgg }">
            ...
            <template v-else>
              ...
              <div :key="'light-user-modal'" class="theme-light-decor absolute inset-0 pointer-events-none transition-all duration-500">
              ...
              <div :key="'dark-user-modal'" class="theme-dark-decor absolute inset-0 pointer-events-none transition-all duration-500">
            ...
            <button @click="showUserModal = false" class="relative z-10 w-9 h-9 flex items-center justify-center rounded-full bg-black/20 hover:bg-black/40 text-white backdrop-blur-sm transition-all shadow-sm border border-white/10">
            ...
            <div class="grid grid-cols-2 gap-5">
              ...
              <div class="col-span-2">
                ...
                <div class="flex gap-2">
                  ...
                  <button type="button" @click="verifyEmail" :disabled="!userForm.email || verifyingEmail || isEmailVerified" :class="['h-11 px-4 rounded-xl text-sm font-bold transition-colors shadow-sm flex items-center justify-center gap-2 whitespace-nowrap', isEmailVerified ? 'bg-[#10b981] text-white border-none' : 'bg-white border border-[#e2e8f0] hover:bg-[#f8f9fa] text-[#364a63] disabled:opacity-50 disabled:cursor-not-allowed']">
          ...
          <div class="p-6 border-t border-[#f1f5f9] bg-[#f8fafc] flex gap-3">
            ...
            <button class="flex-1 h-11 bg-[#4361ee] hover:bg-[#3a0ca3] text-white rounded-xl text-sm font-bold transition-all shadow-sm hover:shadow-md flex items-center justify-center gap-2" :disabled="uSaving || !isEmailVerified" :class="{'opacity-50 cursor-not-allowed': uSaving || !isEmailVerified}" @click="saveUser">
...
<style>
/* Dark Mode Overrides for User Modal Header */
